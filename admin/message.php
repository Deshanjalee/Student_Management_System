...
/*-----------------------------------------if submit is not pressed---------------------------------------*/
		...
		else
		{
			...
			{
				mysqli_query($db,"INSERT into `s_m_s`.`message` VALUES ( '', '$_SESSION[username]', '$_POST[message]', 'no', 'admin');");
...
<!------------- student---------------------------------------->
		<br><div class="chat user">
			<div style="float: left; padding-top: 5px;">
				&nbsp
				<img style="height: 40px; width: 40px; border-radius: 50%;" src="images/25.png">&nbsp
			</div>
			<div style="float: left;" class="chatbox">
				<?php
					echo $row['message'];
