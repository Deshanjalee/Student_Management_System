...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	{
		$q=mysqli_query($db,"SELECT * from result where id like '%$_POST[search]%' ");
	...
	{
			$res=mysqli_query($db,"SELECT * FROM `result` /* ORDER BY `result`.`name` ASC;*/");
	...
	if(isset($_POST['submit1']))
		...
		if(isset($_SESSION['login_user']))
			...
			mysqli_query($db,"DELETE from result where id='$_POST[id]';");
			?>
