...
<div id="main">
   ...
   <div class="container" style="text-align: center;">
     <h2 style="color: black; font-family: Lucida Console; text-align: center;"><b>Add New Result</b></h2>

     <form class="result" action="" method="post">
        ...
        <input type="text" name="grade" class="form-control" placeholder="Grade" required=""><br>
  ...
  <?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"INSERT INTO result VALUES ('$_POST[id]','$_POST[name]','$_POST[gender]','$_POST[subject]','$_POST[marks]','$_POST[grade]');");
