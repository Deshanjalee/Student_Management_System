...
<style type="text/css">
	body
	{
		background-image: url("images/msg4.png");
...
<body>
	...
	{
		mysqli_query($db,"INSERT into `s_m_s`.`message` VALUES ( '', '$_SESSION[login_user]', '$_POST[message]', 'no', 'student');");
	...
	mysqli_query($db,"UPDATE message set status='no' where sender='admin' and username='$_SESSION[login_user]';");
?>
...
?>
		...
		<br><div class="chat admin">
			<div style="float: left; padding-top: 5px;">
				&nbsp
				<img style="height: 40px; width: 40px; border-radius: 50%;" src="images/25.png">
				&nbsp
			</div>
			<div style="float: left;" class="chatbox">
				<?php
