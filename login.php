...
<section>
		...
		<br> <br><br>
			<div class="box1" style="margin-top: 20px;">
				...
				<form name="login" action="" method="post">
					...
					<input style="margin-left: 50px; width: 18px;" type="radio" name="user" id="student" value="student" cheacked="">
	...
	{ 
		...
		if($count==0)
		{
			...
			<div class="alert alert-danger" style="width: 700px;margin-left: 320px;background-color: #bef330">
